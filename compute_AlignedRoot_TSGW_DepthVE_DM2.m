...
for ii = 1:(N-1)
    ...
    for jj=(ii+1):N
        ...
        L1GW_Depth(ii, jj) = DepthBasedTreeGWVE_L1_AlignedTree(XX_path_cell{ii}, XX_path_cell{jj}, ...
            TM, XX_weight_cell{ii}, XX_weight_cell{jj}, 1, 1);
...
save(['twitter_RLT_AR_TSGW_DepthVE_DM2_K' num2str(TM_KC) 'L' num2str(TM_L) 'S' num2str(nTS) '.mat'], 'L1GW_Depth', ...

...
% %     disp(['...' num2str(ii)]);
    for jj=(ii+1):N
        ...
        L1GW_Depth(ii, jj) = DepthBasedTreeGWVVX_L1_AlignedTree(TM, XX_path_cell{ii}, XX_path_cell{jj}, ...
...
save(['twitter_RLT_AR_TSGW_DepthVVX_DM2_K' num2str(TM_KC) 'L' num2str(TM_L) 'S' num2str(nTS) '.mat'], 'L1GW_Depth', ...

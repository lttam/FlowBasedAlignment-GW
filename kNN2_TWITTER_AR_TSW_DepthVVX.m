...
load(['twitter_RLT_AR_TSGW_DepthVVX_DM2_K' num2str(TM_K) 'L' num2str(TM_L) 'S' num2str(nTS) '.mat']);
% L1GW_Flow
...
save(['twitter_RLT_AR_TSGW_DepthVVX_Results2_K' num2str(TM_K) 'L' num2str(TM_L) 'S' num2str(nTS) '.mat'], ...
